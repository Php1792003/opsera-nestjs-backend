...
import { permissionsToString, stringToPermissions, Permission } from './constants/permissions.constant';
...
export class RoleService {
  ...
  async create(dto: CreateRoleDto, tenantId: string) {
    ...
    if (existingRole) {
      throw new ConflictException(`Role "${dto.name}" already exists in your organization.`);
    }
  ...
  async checkUserPermission(userId: string, requiredPermission: Permission): Promise<boolean> {
